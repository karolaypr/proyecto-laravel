...
@section('content')
    ...
    <div class="card">
        ...
        <div class="col-sm-12 col-md-6">
            <form action ="{{route('admin.proyectos.create')}}">
                <button type="submit" class="btn btn-outline-info btn-md">Crear proyecto</button>
            </form>
        </div>
        <div class="card-body">
            <table id="clientes" class="table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$proyecto->name}}</td>
                        <td><a href="../archivos/{{$proyecto->archivo}}" target="_blank">ver archivo</a></td>
                        <td>{{$proyecto->fecha}}</td>
                        <td>
                            <div class="container">
                                <div class="row">
                                    <div class=".col-md-6">
                                        <form action ="{{route('admin.proyectos.edit', $proyecto)}}">
                                    ...
                                    <div class=".col-md-6">
                                        <form action ="{{route('admin.proyectos.destroy', $proyecto)}}" class="formulario-eliminar" method="POST">
