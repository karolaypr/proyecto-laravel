...
@section('content')
    ...
    <div class="card">
        ...
        <div class="col-sm-12 col-md-6">
            <form action ="{{route('admin.documentos.create')}}">
                <button type="submit" class="btn btn-outline-info btn-md">Crear documento</button>
            </form>
        </div>
        <div class="card-body">
                        ...
                        <td>
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class=".col-md-6">
                                        <form action ="{{route('admin.documentos.destroy', $documento)}}" class="formulario-eliminar" method="POST">
