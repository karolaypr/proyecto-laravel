...
@section('content')
    ...
    <div>
        <h1>Lista de Planos Bienes Nacionales</h1>        
    </div>
    <div class="card">
        <br>
        <div class="col-sm-12 col-md-6">
            <form action ="{{route('admin.pbienes.create')}}">
        ...
        <div class="card-body">
            <table id="clientes" class="table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                    @foreach ($pbienes as $pbiene)
                    <tr>
                        <td>{{$pbiene->cliente->name}}</td>
                        <td>{{$pbiene->name}}</td>
                        <td><a href="../archivos/{{$pbiene->archivo}}" target="_blank">ver archivo</a></td>
                        <td>
                            <div class="container">
                                <div class="row">
                                    <div class=".col-md-6">
                                        <form action ="{{route('admin.pbienes.edit', $pbiene)}}">
                                    ...
                                    <div class=".col-md-6">
                                        <form action ="{{route('admin.pbienes.destroy', $pbiene)}}" class="formulario-eliminar" method="POST">
