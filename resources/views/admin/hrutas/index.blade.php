                        ...
                        <td>
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class=".col-md-6">
                                        <form action ="{{route('admin.hrutas.destroy', $hruta)}}" class="formulario-eliminar" method="POST">
...
@section('js')
    ...
    @if (session('eliminar') == 'ok')
        <script>
            Swal.fire(
            'Eliminado',
            'La hoja de ruta ha sido eliminado correctamente.',
            'success'
            )
        </script>
    @endif
    ...
    <script>
        $('.formulario-eliminar').submit(function(e){
            ...
            Swal.fire({
                title: '¿Estás seguro de eliminar la hoja de ruta?',
                icon: 'warning',
