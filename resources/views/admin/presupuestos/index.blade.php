...
@section('content')
    ...
    <div class="card">
        ...
        <div class="col-sm-12 col-md-6">
            <form action ="{{route('admin.presupuestos.create')}}">
                <button type="submit" class="btn btn-outline-info btn-md">Crear presupuesto</button>
            </form>
        </div>
        <div class="card-body">
            <table id="clientes" class="table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$presupuesto->cliente->name}}</td>
