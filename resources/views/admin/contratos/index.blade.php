...
@section('content')
    ...
    <div class="card">
        ...
        <div class="col-sm-12 col-md-6">
            <form action ="{{route('admin.contratos.create')}}">
                <button type="submit" class="btn btn-outline-info btn-md">Crear contrato</button>
            </form>
        </div>
        <div class="card-body">
            <table id="clientes" class="table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$contrato->name}}</td>
                        <td><a href="../archivos/{{$contrato->archivo}}" target="_blank">ver archivo</a></td>
                        <td>{{$contrato->fecha}}</td>
                        <td>
                            <div class="container">
                                <div class="row">
                                    <div class=".col-md-6">
                                        <form action ="{{route('admin.contratos.edit', $contrato)}}">
                                    ...
                                    <div class=".col-md-6">
                                        <form action ="{{route('admin.contratos.destroy', $contrato)}}" class="formulario-eliminar" method="POST">
...
@section('js')
    ...
    <script>
        $('.formulario-eliminar').submit(function(e){
            ...
            Swal.fire({
                title: '¿Estás seguro de eliminar el contrato?',
                icon: 'warning',
